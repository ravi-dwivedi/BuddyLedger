...
import com.ravi.android.buddy.ledger.adaptor.SearchableListAdaptor;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    private SearchableListAdaptor listAdapter;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (null != savedInstanceState) {
            _searchableItem = (SearchableItem) savedInstanceState.getSerializable(ITEMS);
        }
        // Change End
        ...
        String strTitle = _strTitle == null ? "Select Buddy" : _strTitle;
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putSerializable(ITEMS, _searchableItem);
    ...
    private void setData(View rootView) {
        ...
        //       items);
        listAdapter = new SearchableListAdaptor(getActivity(),(ArrayList<String>) items);
        //new SearchableListAdaptor(this.getContext(),null);
